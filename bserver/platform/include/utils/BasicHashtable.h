...
/* Implementation type.  Nothing to see here. */
    ...
    protected:
        ...
        inline Bucket &bucketAt(void *__restrict__ buckets, size_t index) const {
            return *reinterpret_cast<Bucket *>(static_cast<uint8_t *>(buckets) +
                                               index * mBucketSize);
        }
        ...
        virtual void
        initializeBucketEntry(Bucket &bucket, const void *__restrict__ entry) const = 0;
    ...
    private:
        ...
        static void determineCapacity(size_t minimumCapacity, float loadFactor,
                                      size_t *__restrict__ outBucketCount,
                                      size_t *__restrict__ outCapacity);
